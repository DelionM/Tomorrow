...
namespace Tomorrow
{
    public partial class MiFormulario : Form
    {
        ...
        Class1_Dibuja obj_grafico = new Class1_Dibuja();
        ...
        int auxiliar, auxiliar2, k = 0, auxiliar3 = 0;
            ...
            while (k < a.Length)
            {
                switch (a[k])
                {
                    case 'x':
                        ...
                        if (auxiliar2 == 1)
                        {
                            op1x = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                        ...
                        {
                            op2x = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                        ...
                        {
                            op3x = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                    ...
                    case 'y':
                        if (auxiliar2 == 1)
                        {
                            op1y = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                        ...
                        {
                            op2y = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                        ...
                        {
                            op3y = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                    ...
                    case 'z':
                        if (auxiliar2 == 1)
                        {
                            op1z = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                        ...
                        {
                            op2z = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                        ...
                        {
                            op3z = Convert.ToDouble(ObtainTotal(a, auxiliar, k));
                            auxiliar = k + 1;
                    ...
                    case '=':
                        if (auxiliar2 == 1)
                        {
                            op1r = Convert.ToDouble(ObtainRes(a, k + 1, a.Length));
                            auxiliar = k + 1;
                        ...
                        {
                            op2r = Convert.ToDouble(ObtainTotal(a, k + 1, a.Length));
                            auxiliar = k + 1;
                        ...
                        {
                            op3r = Convert.ToDouble(ObtainTotal(a, k + 1, a.Length));
                            auxiliar = k + 1;
